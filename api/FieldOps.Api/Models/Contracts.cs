...
public sealed record CngDispatchDto(string Id, string SourceTrailerId, string SourceTrailerNumber, string? ReplacementTrailerNumber, string Status, double TravelTimeHours, double TargetArrivalPsi, string DispatchedAtIso, string ProjectedArrivalIso, string DispatchedBy);
