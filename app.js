...
function bindModal() {
  ...
  document.querySelector('[data-well-color]')?.addEventListener('change', event => { const customField = document.querySelector('.custom-color-field'); const isCustom = event.currentTarget.value === 'other'; customField?.classList.toggle('hidden', !isCustom); customField?.querySelector('input')?.toggleAttribute('required', isCustom); });
